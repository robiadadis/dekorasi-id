        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div class="flex items-center lg:order-2">
                ...
                <form action="/logout" method="post">
                    @csrf
                    <div class="bg-dark text-white font-bold rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">
                        <button type="submit" class=""><i class="bi bi-box-arrow-right"></i> Logout</button>
                    </div>
                </form>
                @else
                <a href="/login" class="text-white font-bold rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none bg-dark">Log in</a>
                @endauth
